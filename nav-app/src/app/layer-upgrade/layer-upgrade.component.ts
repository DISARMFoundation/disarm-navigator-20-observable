...
export class LayerUpgradeComponent implements OnInit {
    ...
    private descriptions: any = {
        ...
        "changes": "The following techniques have undergone major changes since the layer was created such as changes to scope or technique name. You can view the annotations you had previously added, map them to the current DISARM version, and adjust them as needed. You can also review the previous and current technique definitions by clicking the version numbers in each row.",
        ...
        "unchanged": "These are techniques which have not changed since the uploaded layer's DISARM version. The annotations have automatically been copied for these techniques, but you can review them if desired.",
